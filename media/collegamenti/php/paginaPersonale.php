...
<div class="stagioneAttuale">
    ...
    <h1 style="color: red; font-size: 190%">Acquista un servizio</h1>
    ...
    <div>
        ...
        <h1 style="color: red; font-size: 190%; margin-top: 5%;">Prenota il tuo posto in tribuna</h1>
        <h2 style="color: white; font-size: 150%;">Assisti dal vivo ad un gran Premio di Formula 1</h2>
        <div class="prenotazioni" style="background-color: #f4f4f4; padding: 20px; border-radius: 10px; margin-bottom: 20px;">
            <div style="text-align: center;">
                <img src="../../img/prenotazioni/tribuna_monza.jpg" 
                    width="60%" 
                    style="border-radius: 15px; margin-bottom: 20px;"
                    alt="Tribuna di Monza">
                <p style="font-size: 120%; color: #333; margin: 15px 0;">
                    Scegli il tuo posto preferito tra le diverse tribune disponibili nel circuito di Monza
                </p>
                <a href="./prenotaPosto.php" 
