...
E' possibile consultare tutti i file (contenuti nelle relative cartelle) di questo secondo homework su GitHub: per fare ciò basta cercare l'utente 'simobe-git', accedere alla branch '2ndHomework' e successivamente ci si trova di fronte tutti i file necessari. Per accedere più velocemente, visitare il seguente link:
